...
<table class="table table-bordered table-striped table-auto table-condensed">
	...
	<tbody>
		<?php while ($brand = mysqli_fetch_assoc($results)): ?>
			<tr>
				<td><a href="brands.php?edit=<?php echo $brand['id']; ?>" class="btn btn-secondary"><i class="fas fa-pencil-alt"></i></a></td>
				<td><?php echo $brand['brand'];?></td>
				<td><a href="brands.php?delete=<?php echo $brand['id']; ?>" class="btn btn-secondary"><i class="fas fa-trash-alt"></i></a></td>
			</tr>
	<?php endwhile; ?>
	</tbody>
</table>
